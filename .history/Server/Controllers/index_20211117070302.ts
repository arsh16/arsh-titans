...
export function editSurveyPage(req: Request, res: Response, next: NextFunction): void
{
    ...
    Survey.findById(id, (err: any, surveys: any) =>
    {
        ...
        {
            res.render('index', { title: 'Edit Survey', surveys:surveys,  page : 'edit'});
        }        
    });    
}
...
{
    res.render('index', { title: 'Edit Survey', page: 'edit'});
}
